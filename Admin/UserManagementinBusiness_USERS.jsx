 ...
 * - Now supports toggling between 'Clients' and 'Providers' views.
 */
...
const providersData = [
  { id: 1, name: "Lenin Computer Inc.", email: "samplelenin@gmail.com", status: "Active", avatar: "https://ui-avatars.com/api/?name=Lenin+Computer&background=ef4444&color=fff&size=128" },
  { id: 2, name: "Lenin Computer Inc.", email: "samplelenin@gmail.com", status: "Active", avatar: "https://ui-avatars.com/api/?name=Lenin+Computer&background=ef4444&color=fff&size=128" },
  { id: 3, name: "Lenin Computer Inc.", email: "samplelenin@gmail.com", status: "Deactivated", avatar: "https://ui-avatars.com/api/?name=Lenin+Computer&background=ef4444&color=fff&size=128" },
  { id: 4, name: "Lenin Computer Inc.", email: "samplelenin@gmail.com", status: "Active", avatar: "https://ui-avatars.com/api/?name=Lenin+Computer&background=ef4444&color=fff&size=128" },
  { id: 5, name: "Lenin Computer Inc.", email: "samplelenin@gmail.com", status: "Active", avatar: "https://ui-avatars.com/api/?name=Lenin+Computer&background=ef4444&color=fff&size=128" },
  { id: 6, name: "Lenin Computer Inc.", email: "samplelenin@gmail.com", status: "Pending", avatar: "https://ui-avatars.com/api/?name=Lenin+Computer&background=ef4444&color=fff&size=128" },
  { id: 7, name: "Lenin Computer Inc.", email: "samplelenin@gmail.com", status: "Active", avatar: "https://ui-avatars.com/api/?name=Lenin+Computer&background=ef4444&color=fff&size=128" },
  { id: 8, name: "Lenin Computer Inc.", email: "samplelenin@gmail.com", status: "Active", avatar: "https://ui-avatars.com/api/?name=Lenin+Computer&background=ef4444&color=fff&size=128" },
];
...
const AdminUserManagement = () => {
  ...
  const displayData = activeTab === 'clients' ? clientsData : providersData;
                ...
                {displayData.map((user) => (
                    <div key={user.id} className="bg-white border border-gray-200 rounded-3xl p-6 flex flex-col items-center text-center hover:shadow-lg transition-shadow duration-200 cursor-pointer group">
                        <div className="relative mb-4">
                            <div className={`w-20 h-20 rounded-full overflow-hidden flex items-center justify-center ${activeTab === 'providers' ? 'bg-red-50' : 'bg-teal-800'}`}>
