...
export default function ClientAiLanding() {
          ...
          <div className="w-full min-h-screen flex flex-col items-center pt-12">
            <div className="pt-20 md:pt-28 flex flex-col items-center gap-10"> 
              ...
              <div className="w-full max-w-3xl relative">
                ...
                >
                  <svg className="h-6 w-6 rotate-90" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
