...
// --- Mock Data ---
// Re-created mockShops data locally for this preview
const mockShops = [
  {
    id: 1,
    name: 'TechFix Pro',
    rating: 4.8,
    reviews: 201,
    address: '122 Normal Road, Baliwasan Zamboanga City',
    phone: '(062) 990 8765',
    website: 'techfix.com',
    hours: '9AM - 8PM',
    services: {
      Laptop: ['Screen Replacement', 'Battery Replacement', 'Keyboard Repair', 'Software Troubleshooting'],
      Smartphone: ['Cracked Screen Repair', 'Battery Replacement', 'Charging Port Repair', 'Water Damage Repair'],
      Tablet: ['Screen Replacement', 'Button Repair'],
      Desktop: ['Hardware Upgrades', 'Virus Removal', 'Data Recovery'],
    },
  }
];
...
const mockReviews = [
  {
    ...
    avatar: 'https://placehold.co/40x40/f3e8ff/a855f7?text=U1',
    rating: 5,
    time: '1 Month Ago',
  ...
  },
  {
    id: 2,
    username: 'username_098',
    avatar: 'https://placehold.co/40x40/e0f2fe/0ea5e9?text=U2',
    rating: 4,
    time: '3 Weeks Ago',
    comment: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisque faucibus ex sapien vitae pellentesque sem placerat. In id cursus mi pretium tellus duis convallis. Tempus leo eu aenean sed diam urna tempor.',
    likes: 20,
  },
  {
    id: 3,
    username: 'username_098',
    avatar: 'https://placehold.co/40x40/fefce8/eab308?text=U3',
    rating: 3,
    time: '2 Months Ago',
    comment: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisque faucibus ex sapien vitae pellentesque sem placerat. In id cursus mi pretium tellus duis convallis. Tempus leo eu aenean sed diam urna tempor.',
    likes: 12,
...
function StarRating({ rating }) {
  ...
  if (halfStar) {
    stars.push(<span key="half" className="text-yellow-400">★</span>); // Simplified for preview, could use half-star icon
  }
...
function ShopProfile() {
  const shop = mockShops[0]; // Use the first shop for preview
  ...
  const toggleAccordion = (service) => {
    setActiveAccordion(activeAccordion === service ? null : service);
  };
          ...
          <div className="relative -mt-16 md:-mt-24">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between p-4 bg-white rounded-lg shadow-lg">
              <div className="flex items-center">
                ...
                <div className="ml-4 mt-16 md:mt-0">
                  ...
                  <div className="flex items-center mt-1">
                    ...
                    <span className="text-sm text-gray-600 ml-2">{shop.rating.toFixed(1)} ({shop.reviews} reviews)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-4 md:mt-0 md:mb-2">
                ...
                <a href="#" className="flex items-center justify-center px-5 py-2 rounded-lg border border-gray-300 text-gray-700 font-medium hover:bg-gray-50 transition-colors shadow-sm">
                  <svg className="h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start bg-white rounded-lg shadow-lg p-4 mt-1 border-t border-gray-100">
              ...
              <div className="flex items-center text-sm text-gray-600">
                ...
                <a href="#" className="hover:text-blue-600">{shop.website}</a>
              </div>
              <div className="flex items-center text-sm text-gray-600">
              ...
              <div className="lg:col-span-2 space-y-8">
                <section>
                  ...
                  <div className="space-y-3">
                    {/* Accordions */}
                    {Object.entries(shop.services).map(([service, tasks]) => (
                      <details key={service} className="group border border-gray-200 rounded-lg" open={activeAccordion === service}>
                        <summary 
                          className="flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50"
                          onClick={(e) => { e.preventDefault(); toggleAccordion(service); }}
                        >
                          <div className="flex items-center">
                            {/* You could add icons here based on service name */}
                            <svg className="h-5 w-5 mr-3 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                              {service === 'Laptop' && <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25H3.75A2.25 2.25 0 011.5 15V7.5A2.25 2.25 0 013.75 5.25h16.5A2.25 2.25 0 0122.5 7.5v7.5A2.25 2.25 0 0120.25 17.25H15M9 17.25v3.75h6v-3.75M9 17.25H15" />}
                              {service === 'Smartphone' && <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />}
                              {service === 'Tablet' && <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5h3m-3 0h3m-3 0h3m-6.75 0H21m-16.5 0H2.25m16.5 0H2.25m16.5 0H3.75m16.5 0c.621 0 1.125-.504 1.125-1.125V5.625c0-.621-.504-1.125-1.125-1.125H3.75c-.621 0-1.125.504-1.125 1.125v12.75c0 .621.504 1.125 1.125 1.125z" />}
                              {service === 'Desktop' && <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3.75H15.75V13.5H8.25V3.75zM8.25 13.5L6 18.75h12l-2.25-5.25H8.25zM15 8.25h.008v.008H15V8.25z" />}
                            </svg>
                            <span className="font-medium">{service}</span>
                          </div>
                          <span 
                            className="text-gray-400 transition-transform" 
                            style={{ transform: activeAccordion === service ? 'rotate(180deg)' : 'rotate(0deg)' }}
                          >
                            ▼
                          </span>
                        </summary>
