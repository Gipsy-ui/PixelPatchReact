...
export default function RepairAccepted() {
    ...
    <div className="bg-gray-50 text-gray-900 flex flex-col min-h-screen font-inter">
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full flex-grow">
        ...
        <div className="bg-blue-100 border-l-4 border-blue-500 text-blue-800 p-4 rounded-lg flex justify-between items-center mb-6">
          ...
          <span className="text-xs font-medium bg-blue-200 text-blue-900 px-2.5 py-0.5 rounded-full">
            {status}
          </span>
        </div>
        ...
        <div className="mt-6 bg-blue-100 p-4 rounded-lg flex items-center justify-between">
          <p className="text-sm text-blue-800">
            <span className="font-semibold">Support Center:</span> Having issues with your request?
            <a href="#" className="font-medium underline hover:text-blue-600 ml-1">Contact Support</a>
          </p>
        </div>

        {/* Action Buttons */}
        <div className="mt-8 flex flex-col sm:flex-row justify-end gap-3">
          <button className="rounded-lg border border-gray-300 bg-white py-2 px-5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-100">
            Cancel Request
          </button>

          <button
            onClick={() => navigate(ROUTES.CLIENT_PAYMENT_DETAILS_MODAL)}
            className="rounded-lg border border-transparent bg-blue-600 py-2 px-5 text-sm font-medium text-white shadow-sm hover:bg-blue-700"
          >
            Proceed to Payment
          </button>
        </div>
