export const ROUTES = {
  ...
  SHOP_MANAGEMENT: {
    ...
    DISCOUNTS_MODAL: '/shop/discounts/modal',
    REVIEW: '/shop/review',
  ...
  BUSINESS: {
    ...
    REPAIR_ASSESSMENT_NO_QUOTATION: '/business/repairs/:id/assessment/no-quotation',
    ...
    SERVICE_ADD_DELETE: '/business/services/add-delete',
  SERVICE_DETAIL: '/business/services/detail',
    DISCOUNTS: '/business/discounts',
    SHOP_DISCOUNTS_MODAL: '/business/repairs/discount-modal',
